...
public class BattleSystem : MonoBehaviour
{
    ...
    private const string OVERWORLD_SCENE = "Arena";
    ...
    private void CreateParyEntities()
    {
        List<PartyMember> currentParty = new List<PartyMember>();
        currentParty = partyManager.GetCurrentPary();
    ...
    {
        int damage = currAttacker.Strength; //get damage (can use algorithm)
